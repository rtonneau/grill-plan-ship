...
4. Generates `INDEX.md` (session summary with every ticket and links to its spec and log, plus a `## Branch & PR` section for GitHub sessions plus an `## Issue` section for issue sessions)
