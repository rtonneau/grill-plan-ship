...
<figure>
  <img src="docs/gps-workflow.svg" alt="Dark GPS workflow diagram with GRILL, PLAN, SHIP/IMPLEMENT, and FINISH phases across command, activity, and output columns." />
  <figcaption>
